...
## Current Features
- Title screen with "An Ascendance Of A Bookworm Adventure"
- Academy hallway room with Hannelore intro dialogue
- Scene transition to the Library
- Library room with bookshelves, candelabras, reading desks
- Myne can walk around with arrow keys/WASD + mobile controls
- Myne accidentally picks up the Grutrissheit (looks like a normal book on the floor)
- After picking it up, Myne carries it with her (glowing book in hand)
